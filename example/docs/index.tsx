import { Features, FeaturesProps, Snippet } from '@ayahub/ui';
...
export default () => {
  return (
    <Center gap={32}>
      <Center>
        <h2 style={{ fontSize: 20 }}>To install dumi-theme-ayahub, run the following command:</h2>
        <Snippet language={'bash'}>{'$ bun add dumi dumi-theme-ayahub'}</Snippet>
      </Center>
